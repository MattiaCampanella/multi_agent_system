...
\begin{itemize}
    ...
    \item \textbf{Posizioni degli Agenti:} Ogni agente condivide la stima più recente della posizione osservata degli altri agenti, associata al tick di osservazione; in caso di conflitto tra informazioni, viene mantenuto il dato con timestamp più aggiornato.
\end{itemize}
...
\section{Comportamento su Layout B}
